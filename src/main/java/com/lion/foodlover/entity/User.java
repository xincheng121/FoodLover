...
public class User implements Serializable {
    ...
    @OneToMany(mappedBy = "recipebuyer", cascade = CascadeType.ALL, fetch=FetchType.EAGER)
    private Set<Order> purchaseHistory;
    @OneToMany(mappedBy = "recipemaker", cascade = CascadeType.ALL, fetch=FetchType.EAGER)
